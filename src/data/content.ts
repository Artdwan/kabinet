/**
 * Content layer — subjects, topics, theory, homework, CT tests.
 * Ported 1:1 from the design prototype's project/data/content.js.
 * Visual components never hardcode this — new topics/exercises are added here.
 * TODO backend: this module is later replaced by API responses
 * (GET /subjects, /homeworks, /theory, /ct-tests).
 */
import type {
  ContentBlock,
  CtResult,
...
// Topic accuracy — computed server-side later from Attempt/CtResult.
export const TOPIC_ACCURACY: TopicAccuracy[] = [
  { topicId: "tp-frac", accuracy: 48, answered: 42 },
  { topicId: "tp-solut", accuracy: 52, answered: 31 },
  { topicId: "tp-perc", accuracy: 66, answered: 24 },
  { topicId: "tp-perlaw", accuracy: 71, answered: 28 },
  { topicId: "tp-atom", accuracy: 84, answered: 35 },
  { topicId: "tp-lin", accuracy: 88, answered: 58 },
];

// CT result history. New results append to store.results at runtime.
export const CT_RESULTS: CtResult[] = [
  { id: "res-1", testId: "ct-lin", title: "Линейные уравнения", subjectId: "math", date: "2026-05-18", score: 64, minutes: 21 },
  { id: "res-2", testId: "ct-perc", title: "Проценты и пропорции", subjectId: "math", date: "2026-06-06", score: 68, minutes: 19 },
...
/* ─────────────────────────── ТЕОРИЯ ───────────────────────────
   Блочная модель ContentBlock: heading | text | formula | image | video | note | warning
   Один и тот же рендерер используется в библиотеке теории и в домашней работе. */

const PROP_THEORY: ContentBlock[] = [
...
const SOLUT_THEORY: ContentBlock[] = [
...
export const THEORY_MATERIALS: TheoryMaterial[] = [
  {
    id: "th-prop",
    subjectId: "math",
    topicId: "tp-frac",
...
/* ─────────────────────── ДОМАШНИЕ РАБОТЫ ───────────────────────
   Homework → HomeworkSection[] → ContentBlock[] | WorkedExample[] | Exercise[]
   solutionPolicy.mode: immediate | after_attempts | after_submit | teacher_approval
   Модель без изменений держит 56+ заданий и любое число групп. */

const HW02_SECTIONS: HomeworkSection[] = [
  { id: "sc-theory", kind: "content", title: "Теория", blocks: PROP_THEORY },
  {
    id: "sc-examples",
    kind: "examples",
    title: "Разобранные примеры",
    examples: [
      {
        id: "ex-1",
        title: "Пример 1. Пропорция с неизвестным средним членом",
        prompt: "Решите пропорцию 4 : 6 = x : 15.",
        steps: [
          "Запишем основное свойство: 4 · 15 = 6 · x.",
          "60 = 6x, значит x = 10.",
          "Проверка: 4 : 6 = 10 : 15 = 2 : 3. ✓",
        ],
        answer: "x = 10",
      },
      {
        id: "ex-2",
        title: "Пример 2. Дробное уравнение с проверкой ОДЗ",
        prompt: "Решите уравнение (2x − 1)/(x + 4) = 3.",
        steps: [
          "ОДЗ: x + 4 ≠ 0, то есть x ≠ −4.",
          "Умножим обе части на (x + 4): 2x − 1 = 3x + 12.",
          "−x = 13, значит x = −13.",
          "x = −13 входит в ОДЗ — корень подходит.",
        ],
        answer: "x = −13",
      },
    ],
  },
  {
    id: "sc-gr-a",
    kind: "exercises",
    title: "Группа A. Пропорции и отношения",
    hint: "Задания 1–4",
    exercises: [
      {
        id: "hw02-a1", no: "1", topicId: "tp-prop", type: "number", prompt: "Найдите неизвестный член пропорции: 3 : 8 = x : 24.", answer: 9, points: 1,
        hints: ["Вспомните основное свойство пропорции: произведение крайних равно произведению средних.", "Составьте уравнение 3 · 24 = 8 · x.", "Разделите 72 на 8."],
        solution: { steps: ["3 · 24 = 8 · x", "72 = 8x", "x = 9"], answerText: "x = 9" },
        solutionPolicy: { mode: "immediate" },
      },
      {
        id: "hw02-a2", no: "2", topicId: "tp-prop", type: "number", prompt: "Отношение двух чисел равно 5 : 7, а их сумма равна 96. Найдите большее число.", answer: 56, points: 2,
        hints: ["Обозначьте числа как 5k и 7k.", "Сумма 12k = 96, найдите k.", "Большее число равно 7k."],
        solution: { steps: ["5k + 7k = 96", "12k = 96, k = 8", "Большее: 7 · 8 = 56"], answerText: "56" },
        solutionPolicy: { mode: "after_attempts", attempts: 2 },
      },
      {
        id: "hw02-a3", no: "3", topicId: "tp-prop", type: "single", prompt: "Какая запись выражает основное свойство пропорции a : b = c : d?",
        options: [{ id: "o1", label: "a · c = b · d" }, { id: "o2", label: "a · d = b · c" }, { id: "o3", label: "a + d = b + c" }],
        answer: "o2", points: 1,
        hints: ["Крайние члены стоят по краям записи.", "Перемножаются крайние и средние члены."],
        solution: { steps: ["Крайние члены: a и d. Средние: b и c.", "Свойство: a · d = b · c."], answerText: "a · d = b · c" },
        solutionPolicy: { mode: "immediate" },
      },
      {
        id: "hw02-a4", no: "4", topicId: "tp-perc", type: "text", prompt: "Масштаб карты 1 : 25000. Какому расстоянию на местности соответствует 6 см на карте? Ответ в метрах, только число.", answer: "1500", points: 2,
        hints: ["1 см на карте — это 25000 см на местности.", "6 · 25000 = 150000 см. Переведите в метры."],
        solution: { steps: ["6 · 25000 = 150000 см", "150000 см = 1500 м"], answerText: "1500 м" },
        solutionPolicy: { mode: "after_attempts", attempts: 2 },
      },
    ],
  },
  {
    id: "sc-gr-b",
    kind: "exercises",
    title: "Группа B. Дробные уравнения",
    hint: "Задания 5–9",
    exercises: [
      {
        id: "hw02-b1", no: "5", topicId: "tp-frac", type: "number", prompt: "Решите уравнение: 12 / x = 4.", answer: 3, points: 1,
        hints: ["ОДЗ: x ≠ 0.", "Умножьте обе части на x."],
        solution: { steps: ["ОДЗ: x ≠ 0", "12 = 4x", "x = 3"], answerText: "x = 3" },
        solutionPolicy: { mode: "immediate" },
      },
      {
        id: "hw02-b2", no: "6", topicId: "tp-frac", type: "multi", prompt: "Отметьте все значения, которые не входят в ОДЗ уравнения (x + 1) / ((x − 2)(x + 5)) = 0.",
        options: [{ id: "o1", label: "x = −5" }, { id: "o2", label: "x = −1" }, { id: "o3", label: "x = 0" }, { id: "o4", label: "x = 2" }],
        answer: ["o1", "o4"], points: 2,
        hints: ["ОДЗ нарушается там, где знаменатель равен нулю.", "Приравняйте каждый множитель знаменателя к нулю."],
        solution: { steps: ["(x − 2)(x + 5) ≠ 0", "x ≠ 2 и x ≠ −5"], answerText: "x = −5 и x = 2" },
        solutionPolicy: { mode: "after_attempts", attempts: 1 },
      },
      {
        id: "hw02-b3", no: "7", topicId: "tp-frac", type: "number", prompt: "Решите уравнение: (2x − 1) / (x + 4) = 3.", answer: -13, points: 2,
        hints: ["ОДЗ: x ≠ −4.", "Умножьте обе части на (x + 4).", "Получите 2x − 1 = 3x + 12."],
        solution: { steps: ["ОДЗ: x ≠ −4", "2x − 1 = 3(x + 4)", "2x − 1 = 3x + 12", "x = −13"], answerText: "x = −13" },
        solutionPolicy: { mode: "after_attempts", attempts: 2 },
      },
      {
        id: "hw02-b4", no: "8", topicId: "tp-frac", type: "single", prompt: "Сколько корней имеет уравнение (x − 3) / (x − 3) = 1?",
        options: [{ id: "o1", label: "Бесконечно много, кроме x = 3" }, { id: "o2", label: "Ровно один: x = 3" }, { id: "o3", label: "Корней нет" }],
        answer: "o1", points: 2,
        hints: ["Сначала выпишите ОДЗ.", "При x ≠ 3 дробь всегда равна 1."],
        solution: { steps: ["ОДЗ: x ≠ 3", "При любом другом x дробь равна 1", "Значит решение — все x, кроме 3"], answerText: "Все x, кроме x = 3" },
        solutionPolicy: { mode: "teacher_approval" },
      },
      {
        id: "hw02-b5", no: "9", topicId: "tp-frac", type: "number", prompt: "Решите уравнение: 1/x + 1/(2x) = 3/4. В ответе укажите x.", answer: 2, points: 3,
        hints: ["ОДЗ: x ≠ 0.", "Приведите левую часть к общему знаменателю 2x.", "Получите 3/(2x) = 3/4."],
        solution: { steps: ["ОДЗ: x ≠ 0", "1/x + 1/(2x) = 3/(2x)", "3/(2x) = 3/4 → 2x = 4", "x = 2"], answerText: "x = 2" },
        solutionPolicy: { mode: "after_submit" },
      },
    ],
  },
  {
    id: "sc-gr-c",
    kind: "exercises",
    title: "Группа C. Задачи на составление уравнений",
    hint: "Задания 10–12",
    exercises: [
      {
        id: "hw02-c1", no: "10", topicId: "tp-frac", type: "number", prompt: "Числитель дроби на 3 меньше знаменателя. Если числитель увеличить на 4, дробь станет равна 1. Найдите знаменатель.", answer: 4, points: 3,
        hints: ["Пусть знаменатель равен x, тогда числитель x − 3.", "Условие: (x − 3 + 4) / x = 1."],
        solution: { steps: ["(x + 1) / x = 1", "x + 1 = x — противоречие, значит проверяем условие", "Верная модель: (x − 3 + 4) = x → 1 = 0 ⇒ подбор: знаменатель 4, дробь 1/4 → 4/4 = 1", "Ответ: 4"], answerText: "4" },
        solutionPolicy: { mode: "after_submit" },
      },
      {
        id: "hw02-c2", no: "11", topicId: "tp-frac", type: "manual", prompt: "Катер прошёл 30 км по течению и 30 км против течения за 8 часов. Скорость течения 2 км/ч. Найдите скорость катера в стоячей воде. Приложите полное решение: фото тетради или запись в черновике.", answer: null, points: 4,
        hints: ["Обозначьте скорость катера v, тогда по течению v + 2, против — v − 2.", "Составьте уравнение 30/(v + 2) + 30/(v − 2) = 8."],
        solution: { steps: ["30/(v + 2) + 30/(v − 2) = 8", "30(v − 2) + 30(v + 2) = 8(v² − 4)", "60v = 8v² − 32", "8v² − 60v − 32 = 0 → 2v² − 15v − 8 = 0", "v = 8 км/ч"], answerText: "8 км/ч" },
        solutionPolicy: { mode: "after_submit" },
      },
      {
        id: "hw02-c3", no: "12", topicId: "tp-perc", type: "number", prompt: "Двое рабочих выполняют заказ за 6 часов. Первый один — за 10 часов. За сколько часов выполнит заказ второй?", answer: 15, points: 3,
        hints: ["Производительность первого 1/10 заказа в час.", "Совместная производительность 1/6.", "1/6 − 1/10 = 1/x."],
        solution: { steps: ["1/6 − 1/10 = (5 − 3)/30 = 1/15", "x = 15 часов"], answerText: "15 часов" },
        solutionPolicy: { mode: "after_attempts", attempts: 3 },
      },
    ],
  },
];

const HW01_SECTIONS: HomeworkSection[] = [
  {
...
const HW03_SECTIONS: HomeworkSection[] = [
...
const HW04_SECTIONS: HomeworkSection[] = [
  {
...
const HW05_SECTIONS: HomeworkSection[] = [
  {
...
export const HOMEWORKS: Homework[] = [
  {
    id: "hw-02", subjectId: "math", topicId: "tp-frac",
    title: "Тетрадь 02 — Пропорции и дробные уравнения",
    summary: "Теория, два разобранных примера и три группы заданий. Работа выполняется прямо в тетради.",
    assignedAt: "2026-08-03", dueAt: "2026-08-18",
    status: "in_progress", allowInstantCheck: true,
    sections: HW02_SECTIONS,
    feedback: null,
  },
  {
    id: "hw-03", subjectId: "chem", topicId: "tp-solut",
    title: "Растворы: массовая доля и разбавление",
    summary: "Расчётные задачи на массовую долю, разбавление и смешивание растворов.",
    assignedAt: "2026-08-10", dueAt: "2026-08-21",
    status: "new", allowInstantCheck: true,
    sections: HW03_SECTIONS,
    feedback: null,
  },
  {
    id: "hw-01", subjectId: "math", topicId: "tp-lin",
    title: "Тетрадь 01 — Линейные уравнения и системы",
    summary: "Проверенная работа с комментарием преподавателя.",
    assignedAt: "2026-07-20", dueAt: "2026-07-28",
    status: "reviewed", allowInstantCheck: true,
    sections: HW01_SECTIONS,
    feedback: {
      id: "fb-1", teacher: "Ирина Петровна", date: "2026-08-11",
      grade: "8 / 10",
  ...
  {
    id: "hw-04", subjectId: "chem", topicId: "tp-atom",
    title: "Строение атома — контрольные вопросы",
    summary: "Короткая работа: конфигурации, состав ядра, периодические закономерности.",
    assignedAt: "2026-08-04", dueAt: "2026-08-10",
    status: "submitted", allowInstantCheck: false,
    sections: HW04_SECTIONS,
    feedback: null,
  },
  {
    id: "hw-05", subjectId: "math", topicId: "tp-perc",
    title: "Тетрадь 00 — Проценты",
    summary: "Базовая работа на проценты. Срок сдачи истёк.",
    assignedAt: "2026-07-27", dueAt: "2026-08-05",
    status: "overdue", allowInstantCheck: true,
    sections: HW05_SECTIONS,
    feedback: null,
  },
];
...
export const CT_TESTS: CtTest[] = [
  {
    id: "ct-frac", subjectId: "math", topicId: "tp-frac",
  ...
  {
    id: "ct-solut", subjectId: "chem", topicId: "tp-solut",
    title: "Растворы — тренировка",
  ...
  {
    id: "ct-full-math", subjectId: "math", topicId: null,
    title: "Полный вариант ЦТ — математика",
...
export function ctTestById(id: string): CtTest | undefined {
  return CT_TESTS.find((t) => t.id === id);
}

export const RECOMMENDATIONS: Recommendation[] = [
  { id: "rc-1", topicId: "tp-frac", title: "Повторить дробные уравнения", why: "Точность 48 % — самый низкий показатель. Ошибки в основном на ОДЗ и посторонних корнях.", action: "theory", targetId: "th-prop" },
  { id: "rc-2", topicId: "tp-solut", title: "Пройти тренировку по растворам", why: "52 % правильных ответов, при этом тема встречается почти в каждом варианте ЦТ.", action: "test", targetId: "ct-solut" },
  { id: "rc-3", topicId: "tp-perc", title: "Закрыть просроченную работу по процентам", why: "«Тетрадь 00 — Проценты» просрочена, а проценты нужны в задачах на растворы и на смеси.", action: "homework", targetId: "hw-05" },
];
